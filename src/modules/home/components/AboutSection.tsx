        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <div className="relative">
              <div className="w-full h-[300px] md:h-[400px] lg:h-[500px] bg-gray-200 rounded-lg overflow-hidden shadow-xl">
          ...
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 text-brand-blue leading-tight">
            ...
            <Link
              to="/about"
              className="inline-flex items-center justify-center bg-brand-green text-white px-8 py-3 rounded-md font-bold hover:bg-opacity-90 transition-all group w-full sm:w-auto"
            >
              En savoir plus
